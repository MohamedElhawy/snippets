...
<!-- 
    ...
    upload files function: for uploading any file and store it in any desired directory.

    $file: the uploaded file from ($_FILES["form_input_file_name"]).
    $target_directory: path of the folder you want to store to, relative to the form file.

    return : success message if successed in uploading file.
             error message if failure in uploading file.
